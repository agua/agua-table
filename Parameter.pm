...
method _addStageParameter ( $data ) {
    ...
    my $required_fields = [ "owner", "username", "projectname", "workflowname", "appname", "appnumber", "paramname", "paramnumber", "paramtype", "value", "ordinal" ];
  ...
  $self->logError("undefined values: @$not_defined") and return if @$not_defined;
    ...
    return $self->_addToTable( $table, $data, $required_fields, $required_fields );    
}
